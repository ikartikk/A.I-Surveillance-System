...
mypath = '/Users/ikartik/Desktop/python/computer_vision/test1/student_data'
timages= []
className = []
    ...
    for encode_face, faceloc in zip(encoded_faces,faces_in_frame):
        ...
        if matches[matchIndex]:
           ...
           #y1, x2,y2,x1 = y1*4,x2*4,y2*4,x1*4
            ...
            df = pd.read_csv('/Users/ikartik/Desktop/python/computer_vision/test1/lastSeen.csv')
            ...
            updateCsv('/Users/ikartik/Desktop/python/computer_vision/test1/lastSeen.csv',name,datetime.datetime.now().strftime("%c"))
            break
            ...
            if Name not in mylist:
                ...
                #userinput = input("Press 'S' to start collecting face data and 'Q' to save your picture.")
                ...
                if cv.waitKey(1) & 0xFF == ord('q'):
                    ...
                    while True:
                        ...
                        cv.imwrite('/Users/ikartik/Desktop/python/computer_vision/test1/student_data/'+Name+'.jpg',gray)
                        if cv.waitKey(1) & 0xFF == ord('q'):
